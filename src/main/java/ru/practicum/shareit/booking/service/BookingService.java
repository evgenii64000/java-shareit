...
public interface BookingService {
    ...
    Collection<BookingDto> getBookingsForUser(Long userId, String state, Integer from, Integer size);

    Collection<BookingDto> getBookingsForOwner(Long userId, String state, Integer from, Integer size);
}
